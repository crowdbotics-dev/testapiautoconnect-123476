...
## Project Structure
    ...
    ├── testapiautoconnect_123476  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_123476`
...
2. Clone this repo and `cd testapiautoconnect_123476`
